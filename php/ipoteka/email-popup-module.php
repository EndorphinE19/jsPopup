...
$from = 'From: noreply@ipoteka-kazan.ru' . "\r\n" .
'Reply-To: noreply@ipoteka-kazan.ru' . "\r\n" .
...
createBitrixLead2("Callback", trim($_POST['phone']), $_POST['nameForm'], $_POST['urlWebsite'], "Ключевое слово:" . $utm_t, $utm_s, $utm_m);
